...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, FduceMicrophoneDriverQueueInitialize)
#endif

NTSTATUS
FduceMicrophoneDriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = FduceMicrophoneDriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = FduceMicrophoneDriverEvtIoStop;
...
VOID
FduceMicrophoneDriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
...
VOID
FduceMicrophoneDriverEvtIoStop(
    _In_ WDFQUEUE Queue,
    _In_ WDFREQUEST Request,
